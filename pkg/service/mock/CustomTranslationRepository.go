...
func (_m *CustomTranslationRepository) Contain(ctx context.Context, lang domain.Lang2, text string) (bool, error) {
...
func (_m *CustomTranslationRepository) FindByFirstLetter(ctx context.Context, lang domain.Lang2, firstLetter string) ([]domain.Translation, error) {
...
func (_m *CustomTranslationRepository) FindByText(ctx context.Context, lang domain.Lang2, text string) ([]domain.Translation, error) {
	ret := _m.Called(ctx, lang, text)
...
func (_m *CustomTranslationRepository) FindByTextAndPos(ctx context.Context, lang domain.Lang2, text string, pos domain.WordPos) (domain.Translation, error) {
...
// Remove provides a mock function with given fields: ctx, lang, text, pos
func (_m *CustomTranslationRepository) Remove(ctx context.Context, lang domain.Lang2, text string, pos domain.WordPos) error {
	ret := _m.Called(ctx, lang, text, pos)
...
// Update provides a mock function with given fields: ctx, lang, text, pos, param
func (_m *CustomTranslationRepository) Update(ctx context.Context, lang domain.Lang2, text string, pos domain.WordPos, param service.TranslationUpdateParameter) error {
